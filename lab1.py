...
class lab1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._tune_range = qtgui.Range(700.7*1e6, 907.1*1e6, 0.0125*1e6, 807.2*1e6, 200)
    ...
    def set_tune(self, tune):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.tune, self.samp_rate)
